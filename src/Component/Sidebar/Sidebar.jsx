    ...
    <>
      <div className={`${styles.sidebar} ${(isSearchOpen || isNotificationsOpen) ? styles.sidebarNarrow : ''}`}>
        ...
        <nav className={styles.navMenu}>
          ...
          {/* Messages */}
          <div className={styles.navItem}>
             <img src={messageIcon} alt="Messages" className={styles.navIconImage} />
            <span>Messages</span>
          </div>
          ...
          <NavLink to="/explore" className={({ isActive }) => `${styles.navItem} ${isActive ? styles.active : ''}`}>
             <img src={exploreIcon} alt="Explore" className={styles.navIconImage} />
            <span>Explore</span>
          </NavLink>
        ...
        <div className={styles.moreMenu}>
          ...
          <div className={styles.navItem} onClick={handleLogout}>
             <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ed4956" strokeWidth="2">
                <path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path>
                <polyline points="16 17 21 12 16 7"></polyline>
                <line x1="21" y1="12" x2="9" y2="12"></line>
             </svg>
             <span style={{color: '#ed4956', fontWeight: 'bold'}}>Logout</span>
          </div>
